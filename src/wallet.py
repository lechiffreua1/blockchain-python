...
class Wallet:
    ...
    def load_keys(self):
        try:
            with open('wallet.txt', mode='r') as f:
                ...
                self.public_key = f_content[0][:-1]
                self.private_key = f_content[1]
    ...
    def sign_transaction(self, sender, recipient, amount):
        ...
        hash_data = SHA256.new((str(sender) + str(recipient) + str(amount)).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        hash_data = SHA256.new((str(transaction.sender) + str(transaction.recipient) + str(transaction.amount))
                               .encode('utf8'))

        return verifier.verify(hash_data, binascii.unhexlify(transaction.signature))
